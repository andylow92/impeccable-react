---
id: animate
title: Audit and align motion against the motion-design reference
slug: /impeccable animate
inputs:
  - name: target
    kind: path
    required: true
    description: The component, screen, or directory to audit for motion.
outputs:
  - kind: report
    schema: animate-report-v1
uses_skills:
  - impeccable-ui
uses_references:
  - motion-design
