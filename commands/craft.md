---
id: craft
title: Run the full critique-polish-fix workflow against a target
slug: /impeccable craft
inputs:
  - name: target
    kind: path
    required: true
    description: The component, screen, or directory to craft end-to-end.
  - name: focus
    kind: string
    required: false
