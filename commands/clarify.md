---
id: clarify
title: Audit and rewrite microcopy against the ux-writing reference
slug: /impeccable clarify
inputs:
  - name: target
    kind: path
    required: true
    description: The component, screen, or directory to audit for microcopy.
outputs:
  - kind: report
    schema: clarify-report-v1
uses_skills:
  - impeccable-ui
uses_references:
  - ux-writing
