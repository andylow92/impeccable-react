---
id: delight
title: Introduce purposeful moments of delight on a target
slug: /impeccable delight
inputs:
  - name: target
    kind: path
    required: true
    description: The component, screen, or directory to enhance with deliberate delight.
outputs:
  - kind: report
    schema: delight-report-v1
uses_skills:
  - impeccable-ui
uses_references:
  - motion-design
