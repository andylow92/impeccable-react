---
id: harden
title: Cover error, empty, overflow, and i18n cases for a target
slug: /impeccable harden
inputs:
  - name: target
    kind: path
    required: true
    description: The component, screen, or directory to harden.
outputs:
  - kind: report
    schema: harden-report-v1
uses_skills:
  - impeccable-ui
uses_references:
  - interaction-design
