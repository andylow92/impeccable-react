---
id: colorize
title: Replace generic Tailwind defaults with an earned palette
slug: /impeccable colorize
inputs:
  - name: target
    kind: path
    required: true
    description: The component, screen, or directory whose color palette is being audited.
outputs:
  - kind: report
    schema: colorize-report-v1
uses_skills:
  - impeccable-ui
uses_references:
  - palette-design
