---
id: shape
title: Plan UX/UI structure before any code is written
slug: /impeccable shape
inputs:
  - name: brief
    kind: string
    required: true
    description: A short description of the screen, feature, or flow to be designed.
  - name: target
    kind: path
    required: false
    description: Optional repo or directory whose DESIGN.md should anchor the plan.
outputs:
  - kind: report
    schema: shape-report-v1
uses_skills:
  - impeccable-ui
uses_references:
  - typography
