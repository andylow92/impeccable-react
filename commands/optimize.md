---
id: optimize
title: Audit a target for layout-shift, paint cost, and request waterfall issues
slug: /impeccable optimize
inputs:
  - name: target
    kind: path
    required: true
    description: The component, screen, or directory to audit for runtime cost.
outputs:
  - kind: report
    schema: optimize-report-v1
uses_skills:
  - impeccable-ui
  - impeccable-react
uses_references:
