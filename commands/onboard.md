---
id: onboard
title: Design a first-run flow that drives the user to a single activation step
slug: /impeccable onboard
inputs:
  - name: target
    kind: path
    required: true
    description: The repo or app directory whose first-run flow is being designed or audited.
outputs:
  - kind: report
    schema: onboard-report-v1
uses_skills:
  - impeccable-ui
uses_references:
  - ux-writing
