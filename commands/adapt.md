---
id: adapt
title: Audit and align responsive behavior against the responsive-design reference
slug: /impeccable adapt
inputs:
  - name: target
    kind: path
    required: true
    description: The component, screen, or directory to audit for responsive behavior.
outputs:
  - kind: report
    schema: adapt-report-v1
uses_skills:
  - impeccable-ui
uses_references:
  - responsive-design
