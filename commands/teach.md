---
id: teach
title: One-time setup that captures product context and design tokens
slug: /impeccable teach
inputs:
  - name: target
    kind: path
    required: false
    description: The repository root or app directory to learn from. Defaults to the current working directory.
outputs:
  - kind: report
    schema: teach-report-v1
uses_skills:
  - impeccable-ui
  - impeccable-react
