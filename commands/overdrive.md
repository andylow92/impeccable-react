---
id: overdrive
title: Apply technically sophisticated effects only where they earn their cost
slug: /impeccable overdrive
inputs:
  - name: target
    kind: path
    required: true
    description: The component, screen, or directory under consideration for advanced effects.
outputs:
  - kind: report
    schema: overdrive-report-v1
uses_skills:
  - impeccable-ui
uses_references:
  - motion-design
