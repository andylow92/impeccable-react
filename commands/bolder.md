---
id: bolder
title: Increase visual emphasis on a too-quiet target
slug: /impeccable bolder
inputs:
  - name: target
    kind: path
    required: true
    description: The component, screen, or directory whose hierarchy is too soft.
outputs:
  - kind: report
    schema: bolder-report-v1
uses_skills:
  - impeccable-ui
uses_references:
  - typography
