...
- **palette-design** — Build a palette from ink, paper, and one earned accent — never from Tailwind defaults.
...
- **tailwind-default-palette** [fail] — Brand identity carried by raw Tailwind default colors (blue-500, red-500, green-500, purple-500) — the AI-generated tell.
...
### `/impeccable colorize` — Replace generic Tailwind defaults with an earned palette
